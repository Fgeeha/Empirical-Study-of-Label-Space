...
2. **Label space.** The companion study uses a larger shared label space than the 18 Hybrid classes used here; macro-F1 over a larger class set with rarer classes is both harder and noisier.
3. **Seeds.** The companion study uses more seeds than the three used here; three seeds cannot rule out an occasional collapse that a larger number would reveal.
...
34. Tan, M.; Le, Q.V. EfficientNet: Rethinking model scaling for convolutional neural networks. In *Proceedings of the 36th International Conference on Machine Learning (ICML)*, Long Beach, CA, USA, 9–15 June 2019; PMLR 97, pp. 6105–6114. https://proceedings.mlr.press/v97/tan19a.html
